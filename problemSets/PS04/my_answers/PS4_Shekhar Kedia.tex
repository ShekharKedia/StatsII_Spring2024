...
\begin{itemize}
	\item \textbf{Mother's age (\texttt{m.age}):} Every additional increase in year of mother's age is associated with an increase of 0.008 log hazard on average for child mortality keeping gender of the child constant. 
	\item \textbf{Gender of the child (\texttt{sexfemale}):} With increase in gender value i.e. moving from male to female child, the log hazard for child mortality decreases by 0.082 on average keeping mother's age constant.
\end{itemize}
